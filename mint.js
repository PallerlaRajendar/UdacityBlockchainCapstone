//const SolnSquareVerifier=require("build/SolnSquareVerifier.json")
const HDWalletProvider = require("truffle-hdwallet-provider")
const web3 = require('web3')
const MNEMONIC = "enable actress hunt brush gadget travel salad harvest hire sick iron staff";
const INFURA_KEY = "df69f77ecde149fb9ad848f3f9fe0f85"
const SolnSquare_ADDRESS = "0x9Fd914F3a594DDAd036870134339c0822BE4e4a2"
const OWNER_ADDRESS = "0xce8d3d0206A4C6133C10ef331f4f510ab68EAA26"
...
async function main() {
    ...
    if (SolnSquare_ADDRESS) {
        const solContract = await new web3Instance.eth.Contract(SOL_ABI, SolnSquare_ADDRESS, { gasLimit: "1000000" })
        let proof = {
        ...
        for (var i = 0; i <NUM_CREATURES; ++i) {
            const result = await solContract.methods.mint(OWNER_ADDRESS,i,"URI").send({ from: OWNER_ADDRESS })
